...
class BetterSwerveControllerCommand
    : public CommandHelper<CommandBase, BetterSwerveControllerCommand<NumModules>> {
 ...
 public:
  /**
   * Constructs a new BetterSwerveControllerCommand that when executed will follow the
...
#include "BetterSwerveControllerCommand.inc"